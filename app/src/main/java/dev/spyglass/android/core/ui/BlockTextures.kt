...
object BlockTextures {
    ...
    private val textureMap = mapOf(
        ...
        "resin_brick_slab" to "block_resin_brick_slab",
        "resin_brick_stairs" to "block_resin_brick_stairs",
        "resin_brick_wall" to "block_resin_brick_wall",
        ...
        "oak_stairs" to "block_oak_stairs",
        "spruce_stairs" to "block_spruce_stairs",
        "birch_stairs" to "block_birch_stairs",
        "jungle_stairs" to "block_jungle_stairs",
        "acacia_stairs" to "block_acacia_stairs",
        "dark_oak_stairs" to "block_dark_oak_stairs",
        "stone_stairs" to "block_stone_stairs",
        "cobblestone_stairs" to "block_cobblestone_stairs",
        "stone_brick_stairs" to "block_stone_brick_stairs",
        "mossy_stone_brick_stairs" to "block_mossy_stone_brick_stairs",
        "sandstone_stairs" to "block_sandstone_stairs",
        "red_sandstone_stairs" to "block_red_sandstone_stairs",
        "brick_stairs" to "block_brick_stairs",
        "nether_brick_stairs" to "block_nether_brick_stairs",
        "quartz_stairs" to "block_quartz_stairs",
        "prismarine_stairs" to "block_prismarine_stairs",
        "purpur_stairs" to "block_purpur_stairs",
        "oak_slab" to "block_oak_slab",
        "spruce_slab" to "block_spruce_slab",
        "birch_slab" to "block_birch_slab",
        "jungle_slab" to "block_jungle_slab",
        "acacia_slab" to "block_acacia_slab",
        "dark_oak_slab" to "block_dark_oak_slab",
        "stone_slab" to "block_stone_slab",
        "cobblestone_slab" to "block_cobblestone_slab",
        "stone_brick_slab" to "block_stone_brick_slab",
        "sandstone_slab" to "block_sandstone_slab",
        "brick_slab" to "block_brick_slab",
        "nether_brick_slab" to "block_nether_brick_slab",
        "quartz_slab" to "block_quartz_slab",
        "prismarine_slab" to "block_prismarine_slab",
        "smooth_stone_slab" to "block_smooth_stone_slab",
        "purpur_slab" to "block_purpur_slab",
        "oak_fence" to "block_oak_fence",
        "spruce_fence" to "block_spruce_fence",
        "birch_fence" to "block_birch_fence",
        "jungle_fence" to "block_jungle_fence",
        "acacia_fence" to "block_acacia_fence",
        "dark_oak_fence" to "block_dark_oak_fence",
        "nether_brick_fence" to "block_nether_brick_fence",
        "crimson_fence" to "block_crimson_fence",
        "warped_fence" to "block_warped_fence",
        "oak_door" to "block_oak_door",
        "spruce_door" to "block_spruce_door",
        "birch_door" to "block_birch_door",
        "jungle_door" to "block_jungle_door",
        "acacia_door" to "block_acacia_door",
        "dark_oak_door" to "block_dark_oak_door",
        "iron_door" to "block_iron_door",
        "crimson_door" to "block_crimson_door",
        "warped_door" to "block_warped_door",
        "oak_trapdoor" to "block_oak_trapdoor",
        "spruce_trapdoor" to "block_spruce_trapdoor",
        "birch_trapdoor" to "block_birch_trapdoor",
        "jungle_trapdoor" to "block_jungle_trapdoor",
        "acacia_trapdoor" to "block_acacia_trapdoor",
        "dark_oak_trapdoor" to "block_dark_oak_trapdoor",
        "iron_trapdoor" to "block_iron_trapdoor",
        "crimson_trapdoor" to "block_crimson_trapdoor",
        "warped_trapdoor" to "block_warped_trapdoor",
        ...
        "copper_door" to "block_copper_item",
        ...
        "copper_trapdoor" to "block_copper_item",
        ...
        "heavy_weighted_pressure_plate" to "block_iron_block",
        "light_weighted_pressure_plate" to "block_gold_block",
        ...
        "daylight_detector" to "block_oak_slab",
        "muddy_mangrove_roots" to "block_mud",
        "petrified_oak_slab" to "block_oak_slab",
        ...
        "polished_blackstone_button" to "block_polished_blackstone",
        "polished_blackstone_pressure_plate" to "block_polished_blackstone",
        "stone_button" to "block_stone",
        "stone_pressure_plate" to "block_stone",
    ...
    private fun resolveFallback(blockId: String): SpyglassIcon? {
        ...
        for (suffix in listOf("_slab", "_stairs", "_wall")) {
            ...
            resolveById(base)?.let { return it }
            resolveById("${base}s")?.let { return it }
            resolveById("${base}_block")?.let { return it }
        }
