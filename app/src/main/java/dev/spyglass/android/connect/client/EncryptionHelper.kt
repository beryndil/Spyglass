...
class EncryptionHelper {
    ...
    fun deriveSharedKey(peerPublicKeyBase64: String) {
        ...
        timber.log.Timber.d("Raw secret (${rawSecret.size} bytes), normalized to ${sharedSecret.size} bytes")
        timber.log.Timber.d("Shared secret (first 8): ${sharedSecret.take(8).joinToString("") { "%02x".format(it) }}...")
