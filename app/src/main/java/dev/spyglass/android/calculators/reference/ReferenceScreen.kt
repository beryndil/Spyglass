...
fun ReferenceScreen() {
    Column(
        ...
        ResultCard {
            ORES.forEachIndexed { i, ore ->
                ...
                Row(
                    ...
                    Text(ore.name, style = MaterialTheme.typography.bodyMedium, color = Stone100, modifier = Modifier.weight(1f))
                    Text("Y ${ore.yMin} to ${ore.yMax}", style = MaterialTheme.typography.bodySmall, color = Stone500)
                    Spacer(Modifier.width(8.dp))
                    CategoryBadge(label = "Peak ${ore.peakY}", color = Gold)
                }
            }
        }
        ...
        ResultCard {
            Text("Levels 0-16", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("XP per level", "2L + 7")
            StatRow("Total to 16", "315 XP")
            SpyglassDivider()
            Text("Levels 17-31", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("XP per level", "5L - 38")
            StatRow("Total to 30", "1,395 XP")
            SpyglassDivider()
            Text("Levels 32+", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("XP per level", "9L - 158")
            SpyglassDivider()
            Text("Enchanting Table Slots", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("Slot 1 (cheapest)", "1 Lapis + 1 level")
            StatRow("Slot 2 (mid)", "2 Lapis + 2 levels")
            StatRow("Slot 3 (best)", "3 Lapis + 3 levels")
            SpyglassDivider()
            Text("Anvil", style = MaterialTheme.typography.labelSmall, color = Gold)
        ...
        ResultCard {
            Text("Base Chain", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("Water Bottle", "Starting point")
            StatRow("+ Nether Wart", "Awkward Potion")
            SpyglassDivider()
            Text("Effect Ingredients", style = MaterialTheme.typography.labelSmall, color = Gold)
            StatRow("Sugar", "Speed")
            ...
            SpyglassDivider()
            Text("Modifiers", style = MaterialTheme.typography.labelSmall, color = Gold)
        ...
        ResultCard {
            ...
            SpyglassDivider()
            Text("Key Components", style = MaterialTheme.typography.labelSmall, color = Gold)
        ...
        ResultCard {
            Text("Day/Night Cycle", style = MaterialTheme.typography.labelSmall, color = Gold)
            ...
            SpyglassDivider()
            Text("Breeding & Growth", style = MaterialTheme.typography.labelSmall, color = Gold)
            ...
            SpyglassDivider()
            Text("Crop Growth (avg)", style = MaterialTheme.typography.labelSmall, color = Gold)
            ...
            SpyglassDivider()
            Text("Other Timers", style = MaterialTheme.typography.labelSmall, color = Gold)
            ...
            DYE_COLORS.forEachIndexed { i, dye ->
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        Text(dye.name, style = MaterialTheme.typography.bodyMedium, color = Stone100)
                        Text(dye.source, style = MaterialTheme.typography.bodySmall, color = Stone500)
                    }
                    Text(dye.hex, style = MaterialTheme.typography.bodySmall, color = Stone300)
                }
            }
        }
