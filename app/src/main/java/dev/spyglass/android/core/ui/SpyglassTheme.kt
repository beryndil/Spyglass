...
val ThemePresets: Map<String, SpyglassColors> = mapOf(
    ...
    "creeper" to buildTheme(
        ...
        secondary = Color(0xFF4A6A4A), onSurfaceVariant = Color(0xFFAAD0AA), onSurface = Color(0xFFEAFFEA),
    ),
    "ocean_monument" to buildTheme(
        ...
        secondary = Color(0xFF3A6068), onSurfaceVariant = Color(0xFFA0CCCE), onSurface = Color(0xFFE4F8FF),
    ),
    "deep_dark" to buildTheme(
        ...
        secondary = Color(0xFF345860), onSurfaceVariant = Color(0xFF98BCC2), onSurface = Color(0xFFDEF6FA),
    ),
    "nether_fortress" to buildTheme(
        ...
        secondary = Color(0xFF6A4830), onSurfaceVariant = Color(0xFFCCA888), onSurface = Color(0xFFFFF0D8),
    ),
    "desert_sunset" to buildTheme(
        ...
        secondary = Color(0xFF6E5030), onSurfaceVariant = Color(0xFFCEB088), onSurface = Color(0xFFFFF2D8),
    ),
    "cherry_grove" to buildTheme(
        ...
        secondary = Color(0xFF6A4860), onSurfaceVariant = Color(0xFFCCA8B8), onSurface = Color(0xFFFFECF8),
    ),
    "lush_cave" to buildTheme(
        ...
        secondary = Color(0xFF486040), onSurfaceVariant = Color(0xFFA8C8A0), onSurface = Color(0xFFECFFE4),
    ),
    "end_city" to buildTheme(
        ...
        secondary = Color(0xFF584A68), onSurfaceVariant = Color(0xFFB8AACA), onSurface = Color(0xFFF4E8FF),
    ),
    "sunflower_plains" to buildTheme(
        ...
        secondary = Color(0xFF605840), onSurfaceVariant = Color(0xFFC0B898), onSurface = Color(0xFFFFF6E0),
    ),
    // ── Solid colour themes ─────────────────────────────────────────────────────
